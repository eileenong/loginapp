(function (root, factory) {
  ...
  var Key_getInstance_0 = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.l;
  var Dispatchers_getInstance = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.j;
  var equals = kotlin_kotlin.$_$.m9;
  var toByte = kotlin_kotlin.$_$.qa;
  var toShort = kotlin_kotlin.$_$.sa;
  ...
  var Appendable = kotlin_kotlin.$_$.sb;
  var coerceAtLeast = kotlin_kotlin.$_$.wa;
  var coerceAtMost_0 = kotlin_kotlin.$_$.ya;
  ...
  var isCharSequence = kotlin_kotlin.$_$.y9;
  ...
  function _get_lastReadAvailable__cgybqk($this) {
    ...
    return $this.lastReadAvailable$delegate_1.get_kotlinx$atomicfu$value_vi2am5_k$();
  }
  ...
  function _get_lastReadView__ihufyy($this) {
    ...
    return $this.lastReadView$delegate_1.get_kotlinx$atomicfu$value_vi2am5_k$();
  }
  ...
  function completeReading($this) {
    ...
    var remaining = tmp0_get_readRemaining_epkwe5.get_writePosition_jdt81t_k$() - tmp0_get_readRemaining_epkwe5.get_readPosition_70qxnc_k$() | 0;
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            if (toLong(buffer.get_writePosition_jdt81t_k$() - buffer.get_readPosition_70qxnc_k$() | 0).compareTo_n4fqi2_k$(this.$offset_1) > 0) {
              var tmp0_minOf = toLong(buffer.get_writePosition_jdt81t_k$() - buffer.get_readPosition_70qxnc_k$() | 0).minus_llf5ei_k$(this.$offset_1);
              var tmp1_minOf = toLong(this.$destination_1.get_view_wow8a6_k$().byteLength).minus_llf5ei_k$(this.$destinationOffset_1);
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.set_exceptionState_s9sevl_k$(3);
            if (!(this.n_1 <= (this.dst_1.get_limit_iuokuq_k$() - this.dst_1.get_writePosition_jdt81t_k$() | 0))) {
  ...
  protoOf(ByteChannelSequentialBase).readAvailable_9j2oye_k$ = function (dst, $completion) {
    return this.readAvailable_andnsi_k$(dst instanceof Buffer ? dst : THROW_CCE(), $completion);
  };
  ...
  protoOf(ByteChannelSequentialBase).await_a8ddvc_k$ = function (atLeast, $completion) {
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(toLong(atLeast).compareTo_n4fqi2_k$(new Long(4088, 0)) <= 0)) {
      // Inline function 'io.ktor.utils.io.ByteChannelSequentialBase.await.<anonymous>' call
    ...
    if (this.readable_1.get_remaining_mwegr1_k$().compareTo_n4fqi2_k$(toLong(atLeast)) >= 0)
      return true;
    return this.awaitSuspend_tm3kfc_k$(atLeast, $completion);
  };
  ...
  protoOf(ByteChannelSequentialBase).cancel_as6ug7_k$ = function (cause) {
    ...
    return this.close_9zy44b_k$(cause == null ? CancellationException_init_$Create$('Channel cancelled') : cause);
  };
  ...
  function readAvailable(_this__u8e3s4, dst, $completion) {
    return _this__u8e3s4.readAvailable_sp23sc_k$(dst, 0, dst.length, $completion);
  }
  ...
  function writeFully(_this__u8e3s4, src, $completion) {
    return _this__u8e3s4.writeFully_ol1csb_k$(src, 0, src.length, $completion);
  }
  ...
  protoOf(ChannelJob).join_kbq7u1_k$ = function ($completion) {
    return this.delegate_1.join_kbq7u1_k$($completion);
  };
  ...
  function storeByteArray(_this__u8e3s4, offset, source, sourceOffset, count) {
    ...
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    of(Companion_getInstance_6(), source, sourceOffset, count).copyTo_b1j9k9_k$(_this__u8e3s4, 0, count, offset);
  }
  ...
  function decode(_this__u8e3s4, input, max) {
    ...
    var tmp2_buildString = (tmp0_minOf.compareTo_n4fqi2_k$(tmp1_minOf) <= 0 ? tmp0_minOf : tmp1_minOf).toInt_1tsl84_k$();
    // Inline function 'kotlin.contracts.contract' call
  ...
  function encodeToImpl(_this__u8e3s4, destination, input, fromIndex, toIndex) {
    ...
    try {
      ...
      $l$loop: while (true) {
        ...
        var before = tmp0_anonymous.get_limit_iuokuq_k$() - tmp0_anonymous.get_writePosition_jdt81t_k$() | 0;
        ...
        // Inline function 'io.ktor.utils.io.core.Buffer.writeRemaining' call
        bytesWritten = tmp + (before - (tmp0_anonymous.get_limit_iuokuq_k$() - tmp0_anonymous.get_writePosition_jdt81t_k$() | 0) | 0) | 0;
  ...
  function sizeEstimate(_this__u8e3s4) {
    ...
    if (_this__u8e3s4 instanceof ByteReadPacket) {
      ...
      tmp = tmp0_maxOf.compareTo_n4fqi2_k$(new Long(16, 0)) >= 0 ? tmp0_maxOf : new Long(16, 0);
    }
    return tmp;
  }
  ...
  function encode(_this__u8e3s4, input, fromIndex, toIndex, dst) {
    ...
    try {
      ...
      $l$loop: while (true) {
        ...
        var tmp0_anonymous = tail;
        var rc = encodeArrayImpl(_this__u8e3s4, input, start, toIndex, tmp0_anonymous);
        // Inline function 'kotlin.check' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'kotlin.check' call
        // Inline function 'kotlin.contracts.contract' call
  ...
  protoOf(Buffer).toString = function () {
    // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
    var tmp = this.writePosition_1 - this.readPosition_1 | 0;
    // Inline function 'io.ktor.utils.io.core.Buffer.writeRemaining' call
    var tmp_0 = this.limit_1 - this.writePosition_1 | 0;
    var tmp_1 = this.startGap_1;
    // Inline function 'io.ktor.utils.io.core.Buffer.endGap' call
    return 'Buffer(' + tmp + ' used, ' + tmp_0 + ' free, ' + (tmp_1 + (this.capacity_1 - this.limit_1 | 0) | 0) + ' reserved of ' + this.capacity_1 + ')';
  };
  ...
  function writeBufferAppend(_this__u8e3s4, other, maxSize) {
    // Inline function 'kotlin.comparisons.minOf' call
    // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
    var tmp0_minOf = other.get_writePosition_jdt81t_k$() - other.get_readPosition_70qxnc_k$() | 0;
    ...
    var tmp1_anonymous = _this__u8e3s4.get_memory_gl4362_k$();
    var tmp2_anonymous = _this__u8e3s4.get_writePosition_jdt81t_k$();
    ...
    var tmp0_anonymous = other.get_memory_gl4362_k$();
    var tmp1_anonymous_0 = other.get_readPosition_70qxnc_k$();
    other.get_writePosition_jdt81t_k$();
    tmp0_anonymous.copyTo_b1j9k9_k$(tmp1_anonymous, tmp1_anonymous_0, size, tmp2_anonymous);
    var rc = size;
  ...
  protoOf(DefaultBufferPool).validateInstance_axbz43_k$ = function (instance) {
    ...
    var tmp0_get_size_gkdi02 = instance.get_memory_gl4362_k$();
    // Inline function 'kotlin.contracts.contract' call
    if (!toLong(tmp0_get_size_gkdi02.get_view_wow8a6_k$().byteLength).equals(toLong(this.bufferSize_1))) {
      // Inline function 'io.ktor.utils.io.core.DefaultBufferPool.validateInstance.<anonymous>' call
      var tmp$ret$1;
      // Inline function 'io.ktor.utils.io.bits.Memory.size' call
      var tmp0_get_size_gkdi02_0 = instance.get_memory_gl4362_k$();
      tmp$ret$1 = toLong(tmp0_get_size_gkdi02_0.get_view_wow8a6_k$().byteLength);
      var message = 'Buffer size mismatch. Expected: ' + this.bufferSize_1 + ', actual: ' + toString(tmp$ret$1);
      throw IllegalStateException_init_$Create$(toString(message));
    }
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
  ...
  function writeFully_0(_this__u8e3s4, source, offset, length) {
    ...
    var tmp0_anonymous = _this__u8e3s4.get_memory_gl4362_k$();
    var tmp1_anonymous = _this__u8e3s4.get_writePosition_jdt81t_k$();
    var writeRemaining = _this__u8e3s4.get_limit_iuokuq_k$() - tmp1_anonymous | 0;
    ...
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    of(Companion_getInstance_6(), source, offset, length).copyTo_b1j9k9_k$(tmp0_anonymous, 0, length, tmp1_anonymous);
    var rc = length;
    _this__u8e3s4.commitWritten_xiy30w_k$(rc);
  }
  function writeFully_1(_this__u8e3s4, src, length) {
    ...
    // Inline function 'io.ktor.utils.io.core.writeFully.<anonymous>' call
    src.get_memory_gl4362_k$().copyTo_b1j9k9_k$(tmp0_anonymous, src.get_readPosition_70qxnc_k$(), length, tmp1_anonymous);
  ...
  function writeExact(_this__u8e3s4, size, name, block) {
    ...
    block(tmp0_anonymous, tmp1_anonymous);
    var rc = size;
    _this__u8e3s4.commitWritten_xiy30w_k$(rc);
  }
  function readFully_1(_this__u8e3s4, destination, offset, length) {
    ...
    var tmp0_anonymous = _this__u8e3s4.get_memory_gl4362_k$();
    var tmp1_anonymous = _this__u8e3s4.get_readPosition_70qxnc_k$();
    if ((_this__u8e3s4.get_writePosition_jdt81t_k$() - tmp1_anonymous | 0) < length) {
      throw new EOFException('Not enough bytes to read a byte array of size ' + length + '.');
    }
    copyTo_2(tmp0_anonymous, destination, tmp1_anonymous, length, offset);
  ...
  function readExact(_this__u8e3s4, size, name, block) {
    ...
    var tmp0_anonymous = _this__u8e3s4.get_memory_gl4362_k$();
    var tmp1_anonymous = _this__u8e3s4.get_readPosition_70qxnc_k$();
    if ((_this__u8e3s4.get_writePosition_jdt81t_k$() - tmp1_anonymous | 0) < size) {
      throw new EOFException('Not enough bytes to read a ' + name + ' of size ' + size + '.');
    }
    value = block(tmp0_anonymous, tmp1_anonymous);
    var rc = size;
    _this__u8e3s4.discardExact_ijr9ip_k$(rc);
    return value;
  }
  function readFully_2(_this__u8e3s4, dst, length) {
    ...
    tmp0_anonymous.copyTo_b1j9k9_k$(dst.get_memory_gl4362_k$(), tmp1_anonymous, length, dst.get_writePosition_jdt81t_k$());
  ...
  function writeShort(_this__u8e3s4, value) {
    ...
    tmp0_anonymous.get_view_wow8a6_k$().setInt16(tmp1_anonymous, value, false);
    var rc = 2;
    _this__u8e3s4.commitWritten_xiy30w_k$(rc);
    return Unit_getInstance();
  }
  function writeInt(_this__u8e3s4, value) {
    ...
    tmp0_anonymous.get_view_wow8a6_k$().setInt32(tmp1_anonymous, value, false);
    var rc = 4;
    _this__u8e3s4.commitWritten_xiy30w_k$(rc);
    return Unit_getInstance();
  }
  function writeLong(_this__u8e3s4, value) {
    ...
    tmp0_anonymous.get_view_wow8a6_k$().setInt32(tmp1_anonymous, value.shr_wjue3g_k$(32).toInt_1tsl84_k$(), false);
    tmp0_anonymous.get_view_wow8a6_k$().setInt32(tmp1_anonymous + 4 | 0, value.and_jhajnj_k$(new Long(-1, 0)).toInt_1tsl84_k$(), false);
    var rc = 8;
    _this__u8e3s4.commitWritten_xiy30w_k$(rc);
    return Unit_getInstance();
  }
  function readShort(_this__u8e3s4) {
    ...
    var tmp0_anonymous = _this__u8e3s4.get_memory_gl4362_k$();
    var tmp1_anonymous = _this__u8e3s4.get_readPosition_70qxnc_k$();
    if ((_this__u8e3s4.get_writePosition_jdt81t_k$() - tmp1_anonymous | 0) < 2) {
    ...
    value = tmp0_anonymous.get_view_wow8a6_k$().getInt16(tmp1_anonymous, false);
    var rc = 2;
    _this__u8e3s4.discardExact_ijr9ip_k$(rc);
    return value;
  }
  function readInt(_this__u8e3s4) {
    ...
    var tmp0_anonymous = _this__u8e3s4.get_memory_gl4362_k$();
    var tmp1_anonymous = _this__u8e3s4.get_readPosition_70qxnc_k$();
    if ((_this__u8e3s4.get_writePosition_jdt81t_k$() - tmp1_anonymous | 0) < 4) {
    ...
    value = tmp0_anonymous.get_view_wow8a6_k$().getInt32(tmp1_anonymous, false);
    var rc = 4;
    _this__u8e3s4.discardExact_ijr9ip_k$(rc);
    return value;
  }
  function readLong(_this__u8e3s4) {
    ...
    var tmp0_anonymous = _this__u8e3s4.get_memory_gl4362_k$();
    var tmp1_anonymous = _this__u8e3s4.get_readPosition_70qxnc_k$();
    if ((_this__u8e3s4.get_writePosition_jdt81t_k$() - tmp1_anonymous | 0) < 8) {
    ...
    value = toLong(tmp0_anonymous.get_view_wow8a6_k$().getUint32(tmp1_anonymous, false)).shl_po5ip6_k$(32).or_s401rn_k$(toLong(tmp0_anonymous.get_view_wow8a6_k$().getUint32(tmp1_anonymous + 4 | 0, false)));
    var rc = 8;
    _this__u8e3s4.discardExact_ijr9ip_k$(rc);
    return value;
  }
  function readFloat(_this__u8e3s4) {
    ...
    value = tmp0_anonymous.get_view_wow8a6_k$().getFloat32(tmp1_anonymous, false);
    var rc = 4;
    _this__u8e3s4.discardExact_ijr9ip_k$(rc);
    return value;
  }
  function readDouble(_this__u8e3s4) {
    ...
    value = tmp0_anonymous.get_view_wow8a6_k$().getFloat64(tmp1_anonymous, false);
    var rc = 8;
    _this__u8e3s4.discardExact_ijr9ip_k$(rc);
    return value;
  }
  ...
  function doPrefetch($this, min) {
    ...
    do {
      ...
      if (tail === Companion_getInstance_4().get_Empty_i9b85g_k$()) {
        ...
        tmp$ret$2 = $this.tailRemaining_1.plus_u6jwas_k$(toLong(chunkSize));
        $this.set_tailRemaining_h0rade_k$(tmp$ret$2);
      }
      // Inline function 'kotlin.Long.plus' call
      available = available.plus_u6jwas_k$(toLong(chunkSize));
    }
      ...
      try {
        $l$loop_0: do {
          ...
          $l$block_0: {
            ...
            var tmp0_anonymous_0 = tmp0_anonymous.get_memory_gl4362_k$();
            var tmp1_anonymous = tmp0_anonymous.get_readPosition_70qxnc_k$();
            var tmp2_anonymous = tmp0_anonymous.get_writePosition_jdt81t_k$();
            ...
            if (inductionVariable < tmp2_anonymous)
              do {
                ...
                // Inline function 'io.ktor.utils.io.bits.get' call
                // Inline function 'io.ktor.utils.io.bits.Memory.loadAt' call
                var codepoint = tmp0_anonymous_0.get_view_wow8a6_k$().getInt8(index) & 255;
                var tmp_0;
                if ((codepoint & 128) === 128) {
                  ...
                  if (copied === max) {
                    ...
                    out.append_t8oh9e_k$(tmp0_anonymous_1);
                    copied = copied + 1 | 0;
                    tmp_1 = true;
                  }
                  tmp_0 = !tmp_1;
                ...
                if (tmp_0) {
                  tmp0_anonymous.discardExact_ijr9ip_k$(index - tmp1_anonymous | 0);
                  tmp$ret$4 = false;
                  break $l$block_0;
                }
              }
            ...
            tmp0_anonymous.discardExact_ijr9ip_k$(rc);
            tmp$ret$4 = true;
          }
          var rc_0 = tmp$ret$4;
          var tmp_2;
    ...
    $l$block: {
      ...
      try {
        $l$loop_0: do {
          ...
          var before = tmp0_get_readRemaining_epkwe5.get_writePosition_jdt81t_k$() - tmp0_get_readRemaining_epkwe5.get_readPosition_70qxnc_k$() | 0;
          var after;
          if (before >= size) {
            try {
              ...
              $l$block_3: {
                ...
                if (inductionVariable < tmp2_anonymous)
                  do {
                    ...
                    // Inline function 'io.ktor.utils.io.bits.get' call
                    // Inline function 'io.ktor.utils.io.bits.Memory.loadAt' call
                    var v = tmp0_anonymous_0.get_view_wow8a6_k$().getInt8(index) & 255;
                    if ((v & 128) === 0) {
                      if (!(byteCount === 0)) {
                      ...
                      if (byteCount === 0) {
                        if (isBmpCodePoint(value)) {
                          ...
                          if (copied === max) {
                            ...
                            out.append_t8oh9e_k$(tmp1_anonymous_0);
                            copied = copied + 1 | 0;
                            tmp_1 = true;
                          }
                          if (!tmp_1) {
                            tmp0_anonymous.discardExact_ijr9ip_k$(((index - tmp1_anonymous | 0) - lastByteCount | 0) + 1 | 0);
                            tmp$ret$5 = -1;
                            break $l$block_3;
                          }
                          ...
                          if (copied === max) {
                            ...
                            out.append_t8oh9e_k$(tmp2_anonymous_0);
                            copied = copied + 1 | 0;
                            tmp_3 = true;
                          }
                          if (!tmp_3) {
                            ...
                            if (copied === max) {
                              ...
                              out.append_t8oh9e_k$(tmp3_anonymous);
                              copied = copied + 1 | 0;
                              tmp_4 = true;
                            }
                            tmp_2 = !tmp_4;
              ...
              after = tmp1_get_readRemaining_socv24.get_writePosition_jdt81t_k$() - tmp1_get_readRemaining_socv24.get_readPosition_70qxnc_k$() | 0;
            }
          } else {
            after = before;
          }
          ...
          if (after === 0) {
            ...
            if (after < size) {
              ...
              tmp_6 = (tmp2_get_endGap_b9q7e2.get_capacity_wxbgcd_k$() - tmp2_get_endGap_b9q7e2.get_limit_iuokuq_k$() | 0) < Companion_getInstance_1().get_ReservedSize_b4jt5a_k$();
            }
            if (tmp_6) {
              completeReadHead($this, current);
  ...
  function discardAsMuchAsPossible($this, n, skipped) {
    ...
    $l$1: do {
      $l$0: do {
        ...
        var size = (tmp0_minOf.compareTo_n4fqi2_k$(n_0) <= 0 ? tmp0_minOf : n_0).toInt_1tsl84_k$();
        ...
        // Inline function 'kotlin.Long.plus' call
        $this_0 = $this_0;
        n_0 = n_0.minus_llf5ei_k$(toLong(size));
        skipped_0 = skipped_0.plus_u6jwas_k$(toLong(size));
        continue $l$0;
      }
       while (false);
    }
  ...
  function discardAsMuchAsPossible_0($this, n, skipped) {
    ...
    while (true) {
      ...
      // Inline function 'kotlin.comparisons.minOf' call
      // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
      var tmp0_minOf = current.get_writePosition_jdt81t_k$() - current.get_readPosition_70qxnc_k$() | 0;
  ...
  function readAsMuchAsPossible($this, array, offset, length, copied) {
    ...
    $l$1: do {
      $l$0: do {
        ...
        // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
        var tmp0_minOf = current.get_writePosition_jdt81t_k$() - current.get_readPosition_70qxnc_k$() | 0;
        var size = Math.min(length_0, tmp0_minOf);
  ...
  function fixGapAfterReadFallback($this, current) {
    ...
    // Inline function 'io.ktor.utils.io.core.Buffer.endGap' call
    var tmp0_minOf = tmp - (current.get_capacity_wxbgcd_k$() - current.get_limit_iuokuq_k$() | 0) | 0;
      ...
      $l$0: do {
        ...
        if (next == null) {
          ...
          if (next.get_writePosition_jdt81t_k$() > next.get_readPosition_70qxnc_k$()) {
            ...
            // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
            var tmp1_minus = next.get_writePosition_jdt81t_k$() - next.get_readPosition_70qxnc_k$() | 0;
  ...
  function appendView($this, chunk) {
    ...
    if (tail === Companion_getInstance_4().get_Empty_i9b85g_k$()) {
      ...
      $this.set_tailRemaining_h0rade_k$($this.tailRemaining_1.plus_u6jwas_k$(remainingAll(chunk)));
    }
  }
    ...
    $l$1: do {
      $l$0: do {
        ...
        if (headSize === 0) {
          ...
          var tmp$ret$1;
          // Inline function 'kotlin.Long.minus' call
          tmp$ret$1 = tmp2_this.tailRemaining_1.minus_llf5ei_k$(toLong(copied));
        ...
        // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
        if ((head_0.get_writePosition_jdt81t_k$() - head_0.get_readPosition_70qxnc_k$() | 0) >= minSize_0)
          return head_0;
  ...
  function Input(head, remaining, pool) {
    ...
    tmp.tailRemaining_1 = remaining.minus_llf5ei_k$(toLong(tmp0_minus));
  ...
  protoOf(Input).set_tailRemaining_h0rade_k$ = function (newValue) {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(newValue.compareTo_n4fqi2_k$(new Long(0, 0)) >= 0)) {
  ...
  protoOf(Input).peekTo_56eakp_k$ = function (destination, destinationOffset, offset, min, max) {
    ...
    // Inline function 'kotlin.comparisons.minOf' call
    // Inline function 'io.ktor.utils.io.bits.Memory.size' call
    var tmp0_minOf = toLong(destination.get_view_wow8a6_k$().byteLength).minus_llf5ei_k$(destinationOffset);
    var maxCopySize = max.compareTo_n4fqi2_k$(tmp0_minOf) <= 0 ? max : tmp0_minOf;
    $l$loop: while (copied.compareTo_n4fqi2_k$(min) < 0 ? copied.compareTo_n4fqi2_k$(maxCopySize) < 0 : false) {
      // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
      var tmp1_get_readRemaining_socv24 = current;
      var chunkSize = tmp1_get_readRemaining_socv24.get_writePosition_jdt81t_k$() - tmp1_get_readRemaining_socv24.get_readPosition_70qxnc_k$() | 0;
      if (toLong(chunkSize).compareTo_n4fqi2_k$(skip) > 0) {
        ...
        var size = tmp2_minOf.compareTo_n4fqi2_k$(tmp3_minOf) <= 0 ? tmp2_minOf : tmp3_minOf;
        ...
        // Inline function 'kotlin.Long.minus' call
        skip = skip.minus_llf5ei_k$(toLong(chunkSize));
      }
      var tmp0_elvis_lhs = current.get_next_wor1vg_k$();
      var tmp;
      if (tmp0_elvis_lhs == null) {
  ...
  protoOf(Input).steal_1tck0f_k$ = function () {
    ...
    if (next == null) {
      ...
      var tmp$ret$1;
      // Inline function 'kotlin.Long.minus' call
      var tmp0_minus = this.tailRemaining_1;
      // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
      var tmp1_minus = next.get_writePosition_jdt81t_k$() - next.get_readPosition_70qxnc_k$() | 0;
  ...
  protoOf(Input).append_vlkz76_k$ = function (chain) {
    ...
    if (this._head_1 === Companion_getInstance_4().get_Empty_i9b85g_k$()) {
      ...
      this.set_tailRemaining_h0rade_k$(this.tailRemaining_1.plus_u6jwas_k$(size));
    }
  };
  protoOf(Input).tryWriteAppend_i5mkbp_k$ = function (chain) {
    ...
    if (this.get_head_won7e1_k$() === tail) {
      ...
      var tmp$ret$2;
      // Inline function 'kotlin.Long.plus' call
      tmp$ret$2 = this.tailRemaining_1.plus_u6jwas_k$(toLong(size));
      this.set_tailRemaining_h0rade_k$(tmp$ret$2);
    }
    return true;
  };
  ...
  protoOf(Input).peekTo_xjswhp_k$ = function (buffer) {
    ...
    // Inline function 'kotlin.comparisons.minOf' call
    // Inline function 'io.ktor.utils.io.core.Buffer.writeRemaining' call
    var tmp0_minOf = buffer.get_limit_iuokuq_k$() - buffer.get_writePosition_jdt81t_k$() | 0;
    // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
    var tmp1_minOf = head.get_writePosition_jdt81t_k$() - head.get_readPosition_70qxnc_k$() | 0;
    var size = Math.min(tmp0_minOf, tmp1_minOf);
  ...
  protoOf(Input).fixGapAfterRead_y10io9_k$ = function (current) {
    ...
    // Inline function 'io.ktor.utils.io.core.Buffer.endGap' call
    var tmp0_minOf = tmp_0 - (current.get_capacity_wxbgcd_k$() - current.get_limit_iuokuq_k$() | 0) | 0;
    ...
    if (remaining > overrunSize) {
      ...
      var tmp$ret$3;
      // Inline function 'kotlin.Long.plus' call
      tmp$ret$3 = this.tailRemaining_1.plus_u6jwas_k$(toLong(overrunSize));
      this.set_tailRemaining_h0rade_k$(tmp$ret$3);
    } else {
      _set__head__b4pap2(this, next);
      var tmp$ret$5;
      // Inline function 'kotlin.Long.minus' call
      var tmp2_minus = this.tailRemaining_1;
      // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
      var tmp3_minus = (next.get_writePosition_jdt81t_k$() - next.get_readPosition_70qxnc_k$() | 0) - overrunSize | 0;
      tmp$ret$5 = tmp2_minus.minus_llf5ei_k$(toLong(tmp3_minus));
      this.set_tailRemaining_h0rade_k$(tmp$ret$5);
      ...
      $l$loop: do {
        ...
        if (after === 0) {
          ...
          if (after < size) {
            ...
            // Inline function 'io.ktor.utils.io.core.Buffer.endGap' call
            var tmp2_get_endGap_b9q7e2 = current;
            tmp_1 = (tmp2_get_endGap_b9q7e2.get_capacity_wxbgcd_k$() - tmp2_get_endGap_b9q7e2.get_limit_iuokuq_k$() | 0) < Companion_getInstance_1().get_ReservedSize_b4jt5a_k$();
          }
          if (tmp_1) {
            completeReadHead(_this__u8e3s4, current);
    ...
    $l$block: {
      ...
      try {
        $l$loop_0: do {
          ...
          // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
          var tmp1_minOf = tmp0_anonymous.get_writePosition_jdt81t_k$() - tmp0_anonymous.get_readPosition_70qxnc_k$() | 0;
          ...
          readFully_1(tmp0_anonymous, dst, tmp0_anonymous_0, count);
    ...
    $l$block: {
      ...
      try {
        $l$loop_0: do {
          ...
          var count = Math.min(tmp0_minOf, tmp1_minOf);
          // Inline function 'io.ktor.utils.io.core.readFully.<anonymous>' call
          readFully_2(tmp0_anonymous, dst, count);
          remaining = remaining - count | 0;
          dstOffset = dstOffset + count | 0;
          if (!(remaining > 0)) {
            break $l$loop_0;
    ...
    $l$block: {
      ...
      try {
        $l$loop_0: do {
          ...
          var tmp1_minOf = tmp0_anonymous.get_writePosition_jdt81t_k$() - tmp0_anonymous.get_readPosition_70qxnc_k$() | 0;
          var count = Math.min(tmp0_minOf, tmp1_minOf);
          readBlock(tmp0_anonymous, dstOffset, count);
          remaining = remaining - count | 0;
          dstOffset = dstOffset + count | 0;
          if (!(remaining > 0)) {
            break $l$loop_0;
  ...
  function readLong_0(_this__u8e3s4) {
    ...
    $l$block: {
      ...
      if ((_this__u8e3s4.get_headEndExclusive_yba4hg_k$() - _this__u8e3s4.get_headPosition_sd9ua6_k$() | 0) > 8) {
        ...
        // Inline function 'io.ktor.utils.io.core.readLong.<anonymous>' call
        var tmp0_anonymous = _this__u8e3s4.get_headMemory_zbxxm_k$();
        // Inline function 'io.ktor.utils.io.bits.loadLongAt' call
        tmp$ret$3 = toLong(tmp0_anonymous.get_view_wow8a6_k$().getUint32(index, false)).shl_po5ip6_k$(32).or_s401rn_k$(toLong(tmp0_anonymous.get_view_wow8a6_k$().getUint32(index + 4 | 0, false)));
        break $l$block;
      }
      // Inline function 'io.ktor.utils.io.core.readLong.<anonymous>' call
  ...
  function flushChain($this) {
    ...
    try {
      ...
      $l$loop: do {
        ...
        var tmp0_anonymous = current;
        var tmp_0 = tmp0_anonymous.get_memory_gl4362_k$();
        var tmp_1 = tmp0_anonymous.get_readPosition_70qxnc_k$();
        var tmp$ret$0;
        // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
        tmp$ret$0 = tmp0_anonymous.get_writePosition_jdt81t_k$() - tmp0_anonymous.get_readPosition_70qxnc_k$() | 0;
  ...
  function appendCharFallback($this, c) {
    $l$block: {
      ...
      try {
        ...
        var tmp0_putUtf8Char = buffer.get_memory_gl4362_k$();
        var tmp1_putUtf8Char = buffer.get_writePosition_jdt81t_k$();
  ...
  protoOf(Output).appendChain_diq39b_k$ = function (head) {
    ...
    // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
    var tmp1_minus = tail.get_writePosition_jdt81t_k$() - tail.get_readPosition_70qxnc_k$() | 0;
    var tmp2_toIntOrFail = tmp0_minus.minus_llf5ei_k$(toLong(tmp1_minus));
    ...
    var chainedSizeDelta = tmp2_toIntOrFail.toInt_1tsl84_k$();
  ...
  protoOf(Output).append_t8oh9e_k$ = function (value) {
    ...
    if ((this.tailEndExclusive_1 - tailPosition | 0) >= 3) {
      // Inline function 'io.ktor.utils.io.core.internal.putUtf8Char' call
      var tmp0_putUtf8Char = this.tailMemory_1;
      // Inline function 'kotlin.code' call
      ...
      if (0 <= tmp1_putUtf8Char ? tmp1_putUtf8Char <= 127 : false) {
        ...
        tmp0_putUtf8Char.get_view_wow8a6_k$().setInt8(tailPosition, tmp0_storeAt);
        tmp = 1;
      } else if (128 <= tmp1_putUtf8Char ? tmp1_putUtf8Char <= 2047 : false) {
        // Inline function 'io.ktor.utils.io.bits.set' call
        var tmp1_set = toByte(192 | tmp1_putUtf8Char >> 6 & 31);
        tmp0_putUtf8Char.get_view_wow8a6_k$().setInt8(tailPosition, tmp1_set);
        // Inline function 'io.ktor.utils.io.bits.set' call
        ...
        tmp0_putUtf8Char.get_view_wow8a6_k$().setInt8(tailPosition, tmp4_set);
        // Inline function 'io.ktor.utils.io.bits.set' call
        ...
        tmp0_putUtf8Char.get_view_wow8a6_k$().setInt8(tailPosition, tmp9_set);
        // Inline function 'io.ktor.utils.io.bits.set' call
  ...
  function writeFully_2(_this__u8e3s4, src, length) {
    ...
    try {
      $l$loop: while (true) {
        ...
        var tmp0_minOf = remaining;
        // Inline function 'io.ktor.utils.io.core.Buffer.writeRemaining' call
        var tmp1_minOf = tmp0_anonymous.get_limit_iuokuq_k$() - tmp0_anonymous.get_writePosition_jdt81t_k$() | 0;
        var size = Math.min(tmp0_minOf, tmp1_minOf);
        // Inline function 'io.ktor.utils.io.core.writeFully.<anonymous>' call
  ...
  function writeFullyBytesTemplate(_this__u8e3s4, offset, length, block) {
    ...
    try {
      $l$loop: while (true) {
        ...
        var tmp1_minOf = tmp0_anonymous.get_limit_iuokuq_k$() - tmp0_anonymous.get_writePosition_jdt81t_k$() | 0;
        var size = Math.min(tmp0_minOf, tmp1_minOf);
        block(tmp0_anonymous, currentOffset, size);
        currentOffset = currentOffset + size | 0;
        remaining = remaining - size | 0;
        if (!(remaining > 0))
          break $l$loop;
  ...
  function writeFully_5(_this__u8e3s4, src, offset, length) {
    ...
    try {
      $l$loop: while (true) {
        ...
        var tmp$ret$0;
        // Inline function 'io.ktor.utils.io.core.Buffer.writeRemaining' call
        tmp$ret$0 = tmp0_anonymous.get_limit_iuokuq_k$() - tmp0_anonymous.get_writePosition_jdt81t_k$() | 0;
        var tmp1_minOf = toLong(tmp$ret$0);
        var size = tmp0_minOf.compareTo_n4fqi2_k$(tmp1_minOf) <= 0 ? tmp0_minOf : tmp1_minOf;
        // Inline function 'io.ktor.utils.io.core.writeFully.<anonymous>' call
        var tmp0_anonymous_0 = tmp0_anonymous.get_memory_gl4362_k$();
        var tmp1_anonymous = toLong(tmp0_anonymous.get_writePosition_jdt81t_k$());
        var tmp2_anonymous = currentOffset;
        src.copyTo_w9dpzg_k$(tmp0_anonymous_0, tmp2_anonymous, size, tmp1_anonymous);
        tmp0_anonymous.commitWritten_xiy30w_k$(size.toInt_1tsl84_k$());
        currentOffset = currentOffset.plus_u6jwas_k$(size);
        remaining = remaining.minus_llf5ei_k$(size);
        if (!(remaining.compareTo_n4fqi2_k$(new Long(0, 0)) > 0))
          break $l$loop;
        tail = prepareWriteHead(_this__u8e3s4, 1, tail);
      }
    }finally {
  ...
  function writeFullyBytesTemplate_0(_this__u8e3s4, initialOffset, length, block) {
    ...
    try {
      $l$loop: while (true) {
        ...
        var tmp1_minOf = toLong(tmp$ret$0);
        var size = tmp0_minOf.compareTo_n4fqi2_k$(tmp1_minOf) <= 0 ? tmp0_minOf : tmp1_minOf;
        block(tmp0_anonymous.get_memory_gl4362_k$(), toLong(tmp0_anonymous.get_writePosition_jdt81t_k$()), currentOffset, size);
        tmp0_anonymous.commitWritten_xiy30w_k$(size.toInt_1tsl84_k$());
        currentOffset = currentOffset.plus_u6jwas_k$(size);
        remaining = remaining.minus_llf5ei_k$(size);
        if (!(remaining.compareTo_n4fqi2_k$(new Long(0, 0)) > 0))
  ...
  function writeLong_0(_this__u8e3s4, value) {
    ...
    $l$block: {
      ...
      if ((_this__u8e3s4.get_tailEndExclusive_e33hh8_k$() - index | 0) > 8) {
        ...
        // Inline function 'io.ktor.utils.io.core.writeLong.<anonymous>' call
        var tmp0_anonymous = _this__u8e3s4.get_tailMemory_3da60q_k$();
        // Inline function 'io.ktor.utils.io.bits.storeLongAt' call
        tmp0_anonymous.get_view_wow8a6_k$().setInt32(index, value.shr_wjue3g_k$(32).toInt_1tsl84_k$(), false);
        tmp0_anonymous.get_view_wow8a6_k$().setInt32(index + 4 | 0, value.and_jhajnj_k$(new Long(-1, 0)).toInt_1tsl84_k$(), false);
        tmp$ret$0 = true;
        break $l$block;
      }
      tmp$ret$0 = false;
  ...
  function writeIntByteByByte(_this__u8e3s4, value) {
    ...
    var tmp0_let = toShort(value >>> 16 | 0);
    // Inline function 'kotlin.contracts.contract' call
    var tmp$ret$1;
    // Inline function 'io.ktor.utils.io.bits.highByte' call
    ...
    var tmp1_let = toShort(value & 65535);
    // Inline function 'kotlin.contracts.contract' call
    var tmp$ret$5;
    // Inline function 'io.ktor.utils.io.bits.highByte' call
  ...
  function readBytes(_this__u8e3s4, n) {
    ...
    if (n === VOID) {
      ...
      tmp = tmp0_coerceAtMostMaxIntOrFail.toInt_1tsl84_k$();
    } else {
      tmp = n;
    }
    n = tmp;
  ...
  function writeTextUtf8(_this__u8e3s4, text, fromIndex, toIndex) {
    ...
    try {
      ...
      $l$loop: while (true) {
        ...
        var tmp0_anonymous = tail;
        var memory = tmp0_anonymous.get_memory_gl4362_k$();
        var dstOffset = tmp0_anonymous.get_writePosition_jdt81t_k$();
        var dstLimit = tmp0_anonymous.get_limit_iuokuq_k$();
        ...
        tmp0_anonymous.commitWritten_xiy30w_k$(tmp$ret$1);
        var tmp_0;
        var tmp_1;
        // Inline function 'kotlin.UShort.toInt' call
  ...
  function decodeASCII(_this__u8e3s4, consumer) {
    ...
    if (inductionVariable < tmp2_anonymous)
      do {
        ...
        // Inline function 'io.ktor.utils.io.bits.get' call
        // Inline function 'io.ktor.utils.io.bits.Memory.loadAt' call
        var codepoint = tmp0_anonymous.get_view_wow8a6_k$().getInt8(index) & 255;
        if ((codepoint & 128) === 128 ? true : !consumer(new Char(numberToChar(codepoint)))) {
          _this__u8e3s4.discardExact_ijr9ip_k$(index - tmp1_anonymous | 0);
          return false;
        }
      }
       while (inductionVariable < tmp2_anonymous);
  ...
  function decodeUTF8(_this__u8e3s4, consumer) {
    ...
    if (inductionVariable < tmp2_anonymous)
      do {
        ...
        // Inline function 'io.ktor.utils.io.bits.get' call
        // Inline function 'io.ktor.utils.io.bits.Memory.loadAt' call
        var v = tmp0_anonymous.get_view_wow8a6_k$().getInt8(index) & 255;
        if ((v & 128) === 0) {
          if (!(byteCount === 0)) {
            malformedByteCount(byteCount);
          }
          ...
          if (byteCount === 0) {
            if (isBmpCodePoint(value)) {
              if (!consumer(new Char(numberToChar(value)))) {
                _this__u8e3s4.discardExact_ijr9ip_k$(((index - tmp1_anonymous | 0) - lastByteCount | 0) + 1 | 0);
                return -1;
              }
            } else if (!isValidCodePoint(value)) {
              malformedCodePoint(value);
  ...
  function encodeUTF8(_this__u8e3s4, text, from, to, dstOffset, dstLimit) {
    ...
    $l$loop: do {
      ...
      if ((character & 65408) === 0) {
        ...
        _this__u8e3s4.get_view_wow8a6_k$().setInt8(tmp1, tmp7_storeAt);
      } else {
        break $l$loop;
      }
    }
                  ...
                  $l$loop_0: do {
                    ...
                    if (before >= size) {
                      l$ret$13: do {
                        try {
                              ...
                              do {
                                ...
                                if ((v & 128) === 0) {
                                  ...
                                  l$ret$3: do {
                                    var tmp0_anonymous_1 = numberToChar(v);
                                    var tmp_2;
                                    if (tmp0_anonymous_1 === _Char___init__impl__6a9atx(13)) {
                                      if (this.cr2__1) {
                                        this.end3__1 = true;
                                        tmp$ret$2 = false;
                                        break l$ret$3;
                                      ...
                                      this.cr2__1 = true;
                                      tmp_2 = true;
                                    } else if (tmp0_anonymous_1 === _Char___init__impl__6a9atx(10)) {
                                      this.end3__1 = true;
                                      skip = 1;
                                      tmp_2 = false;
                                    } else {
                                      ...
                                      this.out_1.append_t8oh9e_k$(tmp0_anonymous_1);
                                      tmp_2 = true;
                                    }
                                    tmp$ret$2 = tmp_2;
                                  }
                                  ...
                                  if (byteCount === 0) {
                                    if (isBmpCodePoint(value)) {
                                      ...
                                      l$ret$7: do {
                                        var tmp1_anonymous_0 = numberToChar(value);
                                        var tmp_3;
                                        if (tmp1_anonymous_0 === _Char___init__impl__6a9atx(13)) {
                                          if (this.cr2__1) {
                                            this.end3__1 = true;
                                            tmp$ret$6 = false;
                                            break l$ret$7;
                                          ...
                                          this.cr2__1 = true;
                                          tmp_3 = true;
                                        } else if (tmp1_anonymous_0 === _Char___init__impl__6a9atx(10)) {
                                          this.end3__1 = true;
                                          skip = 1;
                                          tmp_3 = false;
                                        } else {
                                          ...
                                          this.decoded0__1 = this.decoded0__1 + 1 | 0;
                                          this.out_1.append_t8oh9e_k$(tmp1_anonymous_0);
                                          tmp_3 = true;
                                        }
                                        tmp$ret$6 = tmp_3;
                                      }
                                      ...
                                      l$ret$9: do {
                                        var tmp2_anonymous_0 = numberToChar(highSurrogate(value));
                                        var tmp_5;
                                        if (tmp2_anonymous_0 === _Char___init__impl__6a9atx(13)) {
                                          if (this.cr2__1) {
                                            this.end3__1 = true;
                                            tmp$ret$8 = false;
                                            break l$ret$9;
                                          ...
                                          this.cr2__1 = true;
                                          tmp_5 = true;
                                        } else if (tmp2_anonymous_0 === _Char___init__impl__6a9atx(10)) {
                                          this.end3__1 = true;
                                          skip = 1;
                                          tmp_5 = false;
                                        } else {
                                          ...
                                          this.decoded0__1 = this.decoded0__1 + 1 | 0;
                                          this.out_1.append_t8oh9e_k$(tmp2_anonymous_0);
                                          tmp_5 = true;
                                        }
                                        tmp$ret$8 = tmp_5;
                                      }
                                      ...
                                      if (!tmp$ret$8) {
                                        ...
                                        l$ret$11: do {
                                          var tmp3_anonymous = numberToChar(lowSurrogate(value));
                                          var tmp_6;
                                          if (tmp3_anonymous === _Char___init__impl__6a9atx(13)) {
                                            if (this.cr2__1) {
                                              this.end3__1 = true;
                                              tmp$ret$10 = false;
                                              break l$ret$11;
                                            ...
                                            this.cr2__1 = true;
                                            tmp_6 = true;
                                          } else if (tmp3_anonymous === _Char___init__impl__6a9atx(10)) {
                                            this.end3__1 = true;
                                            skip = 1;
                                            tmp_6 = false;
                                          } else {
                                            ...
                                            this.decoded0__1 = this.decoded0__1 + 1 | 0;
                                            this.out_1.append_t8oh9e_k$(tmp3_anonymous);
                                            tmp_6 = true;
                                          }
                                          tmp$ret$10 = tmp_6;
                                        }
                          ...
                          if (skip > 0) {
                            tmp0_anonymous.discardExact_ijr9ip_k$(skip);
                          }
                       ...
                       while (false);
                      var tmp1_get_readRemaining_socv24_0 = current;
                      after = tmp1_get_readRemaining_socv24_0.get_writePosition_jdt81t_k$() - tmp1_get_readRemaining_socv24_0.get_readPosition_70qxnc_k$() | 0;
                    } else {
                      after = before;
                    }
                    release = false;
                    ...
                    if (after === 0) {
                      ...
                      if (after < size) {
                        ...
                        var tmp2_get_endGap_b9q7e2 = current;
                        tmp_8 = (tmp2_get_endGap_b9q7e2.get_capacity_wxbgcd_k$() - tmp2_get_endGap_b9q7e2.get_limit_iuokuq_k$() | 0) < Companion_getInstance_1().get_ReservedSize_b4jt5a_k$();
                      }
                      if (tmp_8) {
  ...
  function ByteReadChannel_0(content, offset, length) {
    ...
    $l$loop: while (true) {
      ...
      var tmp2_minOf = tmp0_get_writeRemaining_370c0c.get_limit_iuokuq_k$() - tmp0_get_writeRemaining_370c0c.get_writePosition_jdt81t_k$() | 0;
  ...
  protoOf(Companion_3).get_Empty_i9b85g_k$ = function () {
    ...
    Empty$factory();
    return this.Empty$delegate_1.get_value_j01efc_k$();
  };
        ...
        $l$loop: do {
          ...
          if (before >= size) {
            try {
              ...
              $l$block_0: {
                ...
                // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
                var bufferSize = tmp0_anonymous.get_writePosition_jdt81t_k$() - tmp0_anonymous.get_readPosition_70qxnc_k$() | 0;
                if (rem < bufferSize) {
                  tmp$ret$3 = 0;
                  break $l$block_0;
                }
                ...
                var tmp0_anonymous_1 = new Int8Array(tmp0_anonymous_0.get_view_wow8a6_k$().buffer, tmp0_anonymous_0.get_view_wow8a6_k$().byteOffset + tmp1_anonymous | 0, tmp2_anonymous - tmp1_anonymous | 0);
                $l$block_2: {
                  ...
                  try {
                    ...
                    $l$block_1: {
                      ...
                      // Inline function 'io.ktor.utils.io.js.decodeWrap' call
                      try {
                        tmp$ret$4 = decoder.decode_pc4594_k$(tmp0_anonymous_1, decodeOptions(true));
                        break $l$block_1;
                      } catch ($p) {
                        if ($p instanceof Error) {
                          var t = $p;
                ...
                if (charactersCopied === max) {
                  ...
                  if (charSequenceLength(tail) > 0) {
                    tmp0_anonymous.rewind_7344q3_k$(bufferSize);
                  }
                  tmp_0 = 0;
          ...
          if (after === 0) {
            ...
            if (after < size) {
              ...
              // Inline function 'io.ktor.utils.io.core.Buffer.endGap' call
              var tmp2_get_endGap_b9q7e2 = current;
              tmp_4 = (tmp2_get_endGap_b9q7e2.get_capacity_wxbgcd_k$() - tmp2_get_endGap_b9q7e2.get_limit_iuokuq_k$() | 0) < Companion_getInstance_1().get_ReservedSize_b4jt5a_k$();
            }
            if (tmp_4) {
      ...
      $l$block_3: {
        ...
        try {
          $l$loop_0: do {
            ...
            var before_0 = tmp0_get_readRemaining_epkwe5_0.get_writePosition_jdt81t_k$() - tmp0_get_readRemaining_epkwe5_0.get_readPosition_70qxnc_k$() | 0;
            var after_0;
            if (before_0 >= size_1) {
              try {
                // Inline function 'io.ktor.utils.io.charsets.decode.<anonymous>' call
                ...
                // Inline function 'kotlin.contracts.contract' call
                // Inline function 'io.ktor.utils.io.core.readDirectInt8Array.<anonymous>' call
                var tmp0_anonymous_2 = tmp1_anonymous_0.get_memory_gl4362_k$();
                var tmp1_anonymous_1 = tmp1_anonymous_0.get_readPosition_70qxnc_k$();
                var tmp2_anonymous_0 = tmp1_anonymous_0.get_writePosition_jdt81t_k$();
                // Inline function 'io.ktor.utils.io.charsets.decode.<anonymous>.<anonymous>' call
                var tmp0_anonymous_3 = new Int8Array(tmp0_anonymous_2.get_view_wow8a6_k$().buffer, tmp0_anonymous_2.get_view_wow8a6_k$().byteOffset + tmp1_anonymous_1 | 0, tmp2_anonymous_0 - tmp1_anonymous_1 | 0);
                ...
                tmp1_anonymous_0.discardExact_ijr9ip_k$(rc_0);
                var rc_1 = rc_0;
                if (rc_1 > 0)
                  size_0 = 1;
                ...
                after_0 = tmp1_get_readRemaining_socv24_0.get_writePosition_jdt81t_k$() - tmp1_get_readRemaining_socv24_0.get_readPosition_70qxnc_k$() | 0;
              }
            } else {
              after_0 = before_0;
            }
            ...
            if (after_0 === 0) {
              ...
              if (after_0 < size_1) {
                ...
                tmp_8 = (tmp2_get_endGap_b9q7e2_0.get_capacity_wxbgcd_k$() - tmp2_get_endGap_b9q7e2_0.get_limit_iuokuq_k$() | 0) < Companion_getInstance_1().get_ReservedSize_b4jt5a_k$();
              }
              if (tmp_8) {
    ...
    if ((input.get_headEndExclusive_yba4hg_k$() - input.get_headPosition_sd9ua6_k$() | 0) >= inputLength) {
      ...
      $l$block: {
        ...
        try {
          ...
          tmp$ret$2 = decoder.decode_ne2v88_k$(subView);
          break $l$block;
        } catch ($p) {
          if ($p instanceof Error) {
            var t = $p;
  ...
  function decodeExactBytesSlow(_this__u8e3s4, input, inputLength) {
    ...
    $l$block_4: {
      ...
      try {
            ...
            $l$loop: do {
              ...
              if (before >= size) {
                try {
                  ...
                  var tmp0_anonymous = current;
                  // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
                  var chunkSize = tmp0_anonymous.get_writePosition_jdt81t_k$() - tmp0_anonymous.get_readPosition_70qxnc_k$() | 0;
                  // Inline function 'kotlin.comparisons.minOf' call
                  var tmp0_minOf = inputRemaining;
                  var size_0 = Math.min(chunkSize, tmp0_minOf);
                  var tmp_0;
                  if (tmp0_anonymous.get_readPosition_70qxnc_k$() === 0 ? tmp0_anonymous.get_memory_gl4362_k$().get_view_wow8a6_k$().byteLength === size_0 : false) {
                    var tmp$ret$4;
                    $l$block_0: {
                      // Inline function 'io.ktor.utils.io.js.decodeStream' call
                      var tmp1_decodeStream = tmp0_anonymous.get_memory_gl4362_k$().get_view_wow8a6_k$();
                      // Inline function 'io.ktor.utils.io.js.decodeWrap' call
                      try {
                    ...
                    $l$block_1: {
                      // Inline function 'io.ktor.utils.io.js.decodeStream' call
                      var tmp2_decodeStream = new Int8Array(tmp0_anonymous.get_memory_gl4362_k$().get_view_wow8a6_k$().buffer, tmp0_anonymous.get_memory_gl4362_k$().get_view_wow8a6_k$().byteOffset + tmp0_anonymous.get_readPosition_70qxnc_k$() | 0, size_0);
                      // Inline function 'io.ktor.utils.io.js.decodeWrap' call
                      try {
                  ...
                  tmp0_anonymous.discardExact_ijr9ip_k$(size_0);
              ...
              if (after === 0) {
                ...
                if (after < size) {
                  ...
                  // Inline function 'io.ktor.utils.io.core.Buffer.endGap' call
                  var tmp2_get_endGap_b9q7e2 = current;
                  tmp_2 = (tmp2_get_endGap_b9q7e2.get_capacity_wxbgcd_k$() - tmp2_get_endGap_b9q7e2.get_limit_iuokuq_k$() | 0) < Companion_getInstance_1().get_ReservedSize_b4jt5a_k$();
                }
                if (tmp_2) {
                  completeReadHead(input, current);
          ...
          $l$block_2: {
            ...
            try {
              $l$loop_1: do {
                ...
                // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
                var chunkSize_0 = tmp1_anonymous.get_writePosition_jdt81t_k$() - tmp1_anonymous.get_readPosition_70qxnc_k$() | 0;
                // Inline function 'kotlin.comparisons.minOf' call
                var tmp0_minOf_0 = inputRemaining;
                var size_1 = Math.min(chunkSize_0, tmp0_minOf_0);
                var tmp_5;
                if (tmp1_anonymous.get_readPosition_70qxnc_k$() === 0 ? tmp1_anonymous.get_memory_gl4362_k$().get_view_wow8a6_k$().byteLength === size_1 : false) {
                  tmp_5 = decoder.decode_ne2v88_k$(tmp1_anonymous.get_memory_gl4362_k$().get_view_wow8a6_k$());
                } else {
                  var tmp$ret$14;
                  $l$block_3: {
                    // Inline function 'io.ktor.utils.io.js.decodeStream' call
                    var tmp1_decodeStream_0 = new Int8Array(tmp1_anonymous.get_memory_gl4362_k$().get_view_wow8a6_k$().buffer, tmp1_anonymous.get_memory_gl4362_k$().get_view_wow8a6_k$().byteOffset + tmp1_anonymous.get_readPosition_70qxnc_k$() | 0, size_1);
                    // Inline function 'io.ktor.utils.io.js.decodeWrap' call
                    try {
                ...
                tmp1_anonymous.discardExact_ijr9ip_k$(size_1);
        ...
        sb.append_ssq29y_k$(decoder.decode_m3924y_k$());
        break $l$block_4;
      } catch ($p) {
        if ($p instanceof Error) {
          var t_2 = $p;
  ...
  function decodeBufferImplSlow(_this__u8e3s4, nativeDecoder, maxCharacters) {
    ...
    $l$block: {
      ...
      try {
        ...
        nativeDecoder.decode_ne2v88_k$(_this__u8e3s4);
        break $l$block;
      } catch ($p) {
        if ($p instanceof Error) {
          var t = $p;
  ...
  function encodeISO88591(input, fromIndex, toIndex, dst) {
    ...
    var tmp0_anonymous = dst.get_memory_gl4362_k$();
    var tmp1_anonymous = dst.get_writePosition_jdt81t_k$();
    var tmp2_anonymous = dst.get_limit_iuokuq_k$();
    // Inline function 'io.ktor.utils.io.charsets.encodeISO88591.<anonymous>' call
    var tmp0_anonymous_0 = tmp0_anonymous.slice_z7nwcu_k$(tmp1_anonymous, tmp2_anonymous - tmp1_anonymous | 0).get_view_wow8a6_k$();
  ...
  function writeFully_6(_this__u8e3s4, src, offset, length) {
    ...
    var tmp0_anonymous = _this__u8e3s4.get_memory_gl4362_k$();
    var tmp1_anonymous = _this__u8e3s4.get_writePosition_jdt81t_k$();
    if ((_this__u8e3s4.get_limit_iuokuq_k$() - tmp1_anonymous | 0) < length) {
  ...
  function readAvailable_0(_this__u8e3s4, dst, offset, length) {
    ...
    // Inline function 'kotlin.comparisons.minOf' call
    // Inline function 'io.ktor.utils.io.core.Buffer.readRemaining' call
    var tmp0_minOf = _this__u8e3s4.get_writePosition_jdt81t_k$() - _this__u8e3s4.get_readPosition_70qxnc_k$() | 0;
    var readSize = Math.min(length, tmp0_minOf);
  ...
  function writeDirect(_this__u8e3s4, block) {
    ...
    var tmp0_anonymous = _this__u8e3s4.get_memory_gl4362_k$();
    var tmp1_anonymous = _this__u8e3s4.get_writePosition_jdt81t_k$();
    var tmp2_anonymous = _this__u8e3s4.get_limit_iuokuq_k$();
    var rc = block(tmp0_anonymous.slice_z7nwcu_k$(tmp1_anonymous, tmp2_anonymous - tmp1_anonymous | 0).get_view_wow8a6_k$());
    _this__u8e3s4.commitWritten_xiy30w_k$(rc);
    return rc;
  }
  function readFully_5(_this__u8e3s4, dst, offset, length) {
    ...
    copyTo_1(tmp0_anonymous, dst, tmp1_anonymous, length, offset);
    var rc = length;
    _this__u8e3s4.discardExact_ijr9ip_k$(rc);
  }
  function readDirectInt8Array(_this__u8e3s4, block) {
    ...
    var tmp1_anonymous = _this__u8e3s4.get_readPosition_70qxnc_k$();
    var tmp2_anonymous = _this__u8e3s4.get_writePosition_jdt81t_k$();
    var rc = block(new Int8Array(tmp0_anonymous.get_view_wow8a6_k$().buffer, tmp0_anonymous.get_view_wow8a6_k$().byteOffset + tmp1_anonymous | 0, tmp2_anonymous - tmp1_anonymous | 0));
    _this__u8e3s4.discardExact_ijr9ip_k$(rc);
    return rc;
  }
  ...
  function readAvailable_1(_this__u8e3s4, dst, offset, length) {
    ...
    var size = (remaining.compareTo_n4fqi2_k$(tmp0_minOf) <= 0 ? remaining : tmp0_minOf).toInt_1tsl84_k$();
    ...
    $l$block: {
      ...
      try {
        $l$loop_0: do {
          // Inline function 'io.ktor.utils.io.core.readFully.<anonymous>' call
          var tmp0_anonymous = current;
          var rc = readAvailable_0(tmp0_anonymous, dst, offset + copied | 0, length - copied | 0);
          if (rc > 0)
            copied = copied + rc | 0;
          if (!(copied < length)) {
            break $l$loop_0;
  ...
  function TextDecoderFallback(encoding, fatal) {
    ...
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!get_ENCODING_ALIASES().contains_2ehdt1_k$(requestedEncoding)) {
  ...
  function DefaultPool(capacity) {
    ...
    tmp.instances_1 = fillArrayVal(Array(tmp0_arrayOfNulls), null);
    this.size_1 = 0;
  }

(function (root, factory) {
  ...
  var ClosedRange = kotlin_kotlin.$_$.va;
  ...
  var isUpperCase = kotlin_kotlin.$_$.lc;
  ...
  var coerceAtMost = kotlin_kotlin.$_$.ya;
  ...
  var DeepRecursiveFunction = kotlin_kotlin.$_$.wd;
  var invoke = kotlin_kotlin.$_$.af;
  var CoroutineImpl = kotlin_kotlin.$_$.t8;
  var DeepRecursiveScope = kotlin_kotlin.$_$.xd;
  ...
  var IllegalArgumentException = kotlin_kotlin.$_$.be;
  var isFinite = kotlin_kotlin.$_$.cf;
  var isFinite_0 = kotlin_kotlin.$_$.bf;
  var decodeNullableSerializableValue = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.q1;
  ...
  var encodeSerializableValue = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.w1;
  var shouldEncodeElementDefault = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.o1;
  ...
  var last_0 = kotlin_kotlin.$_$.y6;
  var removeLast = kotlin_kotlin.$_$.j7;
  var lastIndexOf = kotlin_kotlin.$_$.oc;
  ...
  var chunked = kotlin_kotlin.$_$.tb;
  ...
  protoOf(JsonBuilder).set_decodeEnumsCaseInsensitive_rnkh5b_k$ = function (_set____db54di) {
  ...
  function get_int(_this__u8e3s4) {
    ...
    var tmp0_contains = numberRangeToNumber(IntCompanionObject_getInstance().get_MIN_VALUE_7nmmor_k$(), IntCompanionObject_getInstance().get_MAX_VALUE_54a9lf_k$());
  ...
  protoOf(JsonNamingStrategy$Builtins$SnakeCase$1).serialNameForJson_hcdeen_k$ = function (descriptor, elementIndex, serialName) {
    // Inline function 'kotlin.text.buildString' call
    var tmp0_buildString = imul(serialName.length, 2);
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'kotlin.apply' call
    ...
    while (inductionVariable < last_0) {
      ...
      if (isUpperCase(element)) {
        ...
        if (previousUpperCharsCount === 0) {
          ...
          tmp_0 = charSequenceLength(tmp0_apply) > 0;
        } else {
          tmp_0 = false;
        }
        if (tmp_0) {
          tmp = !(last(tmp0_apply) === _Char___init__impl__6a9atx(95));
        } else {
          tmp = false;
        }
        if (tmp) {
        ...
        if ((tmp_1 == null ? null : new Char(tmp_1)) == null)
          ...
          // Inline function 'kotlin.let' call
          // Inline function 'kotlin.contracts.contract' call
          tmp0_apply.append_t8oh9e_k$(tmp0_safe_receiver);
        }
        ...
        // Inline function 'kotlin.js.unsafeCast' call
        // Inline function 'kotlin.js.asDynamic' call
        tmp$ret$5 = toString_0(element).toLowerCase();
  ...
  protoOf(Composer).print_wuq48e_k$ = function (v) {
    return this.writer_1.writeLong_91l7mc_k$(toLong(v));
  };
  ...
  function getJsonNameIndexSlowPath(_this__u8e3s4, json, name) {
    _init_properties_JsonNamesMap_kt__cbbp0k();
    var tmp0_elvis_lhs = deserializationNamesMap(json, _this__u8e3s4).get_1mhr4y_k$(name);
    ...
    if (inductionVariable < last)
      do {
        ...
        if (useLowercaseEnums) {
          // Inline function 'kotlin.text.lowercase' call
          // Inline function 'kotlin.js.asDynamic' call
          tmp_0 = _this__u8e3s4.getElementName_ykpypc_k$(i).toLowerCase();
        } else if (!(strategyForClasses == null)) {
          tmp_0 = strategyForClasses.serialNameForJson_hcdeen_k$(_this__u8e3s4, i, _this__u8e3s4.getElementName_ykpypc_k$(i));
        } else {
          tmp_0 = null;
        }
        var nameToPut = tmp_0;
  ...
  function buildDeserializationNamesMap$putOrThrow(_this__u8e3s4, $this_buildDeserializationNamesMap, name, index) {
    ...
    if ((isInterface(_this__u8e3s4, Map) ? _this__u8e3s4 : THROW_CCE()).containsKey_wgk31w_k$(name)) {
      throw new JsonException("The suggested name '" + name + "' for " + entity + ' ' + $this_buildDeserializationNamesMap.getElementName_ykpypc_k$(index) + ' is already one of the names for ' + entity + ' ' + ($this_buildDeserializationNamesMap.getElementName_ykpypc_k$(getValue(_this__u8e3s4, name)) + ' in ' + $this_buildDeserializationNamesMap));
    }
  ...
  protoOf(JsonTreeReader).read_22xsm_k$ = function () {
    ...
    if (token === get_TC_STRING()) {
      ...
      this.lexer_1.fail$default_dmej3o_k$('Cannot read Json element because of unexpected ' + tokenDescription(token));
    }
    return tmp;
  };
  ...
  function coerceInputValue($this, descriptor, index) {
    ...
    $l$block_2: {
      ...
      if (!tmp1_tryCoerceValue.get_isNullable_67sy7o_k$()) {
        ...
        tmp = $this.lexer_1.tryConsumeNull_c55xgu_k$(true);
      } else {
        tmp = false;
      }
      if (tmp) {
      ...
      if (equals(tmp1_tryCoerceValue.get_kind_wop7ml_k$(), ENUM_getInstance())) {
        ...
        if (tmp1_tryCoerceValue.get_isNullable_67sy7o_k$()) {
          // Inline function 'kotlinx.serialization.json.internal.StreamingJsonDecoder.coerceInputValue.<anonymous>' call
          tmp_0 = $this.lexer_1.tryConsumeNull_c55xgu_k$(false);
        } else {
          tmp_0 = false;
        }
        if (tmp_0) {
  ...
  protoOf(StreamingJsonDecoder).decodeSerializableValue_6v83lo_k$ = function (deserializer) {
    try {
      ...
      var type = this.lexer_1.peekLeadingMatchingValue_n1f74e_k$(discriminator, this.configuration_1.get_isLenient_1g1x8_k$());
  ...
  protoOf(AbstractJsonTreeDecoder).decodeInline_k1q7ba_k$ = function (descriptor) {
    return !(this.get_currentTagOrNull_yhyzw_k$() == null) ? protoOf(NamedValueDecoder).decodeInline_k1q7ba_k$.call(this, descriptor) : (new JsonPrimitiveDecoder(this.get_json_woos35_k$(), this.get_value_j01efc_k$())).decodeInline_k1q7ba_k$(descriptor);
  };
  ...
  protoOf(JsonTreeDecoder).elementName_9sehmv_k$ = function (descriptor, index) {
    ...
    $l$block: {
      ...
      while (tmp0_iterator.hasNext_bitz1p_k$()) {
        ...
        if (deserializationNamesMap_0.get_1mhr4y_k$(element) === index) {
          tmp$ret$1 = element;
          break $l$block;
        }
      }
    ...
    var fallbackName = strategy == null ? null : strategy.serialNameForJson_hcdeen_k$(descriptor, index, baseName);
  ...
  protoOf(JsonTreeDecoder).beginStructure_dv3yt3_k$ = function (descriptor) {
    if (descriptor === this.polyDescriptor_1) {
      ...
      // Inline function 'kotlinx.serialization.json.internal.cast' call
      var tmp0_cast = this.currentObject_yxe2oo_k$();
      var tmp1_cast = this.polyDescriptor_1;
      if (!(tmp0_cast instanceof JsonObject)) {
        throw JsonDecodingException_1(-1, 'Expected ' + getKClass(JsonObject) + ' as the serialized body of ' + tmp1_cast.get_serialName_u2rqhk_k$() + ', but had ' + getKClassFromExpression(tmp0_cast));
      }
      return new JsonTreeDecoder(tmp, tmp0_cast, this.polyDiscriminator_1, this.polyDescriptor_1);
    }
  ...
  protoOf(AbstractJsonTreeEncoder).encodeSerializableValue_g55msp_k$ = function (serializer, value) {
    if (!(this.get_currentTagOrNull_yhyzw_k$() == null) ? true : !get_requiresTopLevelTag(carrierDescriptor(serializer.get_descriptor_wjt6a0_k$(), this.get_serializersModule_piitvg_k$()))) {
      ...
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeEncoder.encodeSerializableValue.<anonymous>' call
      (new JsonPrimitiveEncoder(this.json_1, this.nodeConsumer_1)).encodeSerializableValue_g55msp_k$(serializer, value);
    }
  };
  ...
  protoOf(AbstractJsonTreeEncoder).encodeInline_8gn4q6_k$ = function (descriptor) {
    return !(this.get_currentTagOrNull_yhyzw_k$() == null) ? protoOf(NamedValueEncoder).encodeInline_8gn4q6_k$.call(this, descriptor) : (new JsonPrimitiveEncoder(this.json_1, this.nodeConsumer_1)).encodeInline_8gn4q6_k$(descriptor);
  };
  ...
  function consumeNumericLiteral$calculateExponent(exponentAccumulator, isExponentPositive) {
    ...
    switch (isExponentPositive) {
      case false:
        ...
        var tmp0_pow = -exponentAccumulator.toDouble_ygsx0s_k$();
        tmp = Math.pow(10.0, tmp0_pow);
        break;
      case true:
        // Inline function 'kotlin.math.pow' call

        var tmp1_pow = exponentAccumulator.toDouble_ygsx0s_k$();
  ...
  protoOf(AbstractJsonLexer).consumeNextToken_trhodc_k$ = function (expected) {
    ...
    if (!(token === expected)) {
      this.fail$default_6yvuyu_k$(expected);
    }
    return token;
  };
  ...
  protoOf(AbstractJsonLexer).unexpectedToken_v8110b_k$ = function (expected) {
    if (this.currentPosition_1 > 0 ? expected === _Char___init__impl__6a9atx(34) : false) {
      ...
      if (inputLiteral === 'null') {
        this.fail_icoaf1_k$("Expected string literal but 'null' literal was found", this.currentPosition_1 - 1 | 0, "Use 'coerceInputValues = true' in 'Json {}' builder to coerce nulls to default values.");
      }
    }
    this.fail$default_6yvuyu_k$(charToTokenClass(expected));
  };
  protoOf(AbstractJsonLexer).fail_7e8ajq_k$ = function (expectedToken, wasConsumed) {
    ...
    this.fail$default_dmej3o_k$('Expected ' + expected + ", but had '" + s + "' instead", position);
  };
  protoOf(AbstractJsonLexer).fail$default_6yvuyu_k$ = function (expectedToken, wasConsumed, $super) {
    wasConsumed = wasConsumed === VOID ? true : wasConsumed;
    return $super === VOID ? this.fail_7e8ajq_k$(expectedToken, wasConsumed) : $super.fail_7e8ajq_k$.call(this, expectedToken, wasConsumed);
  };
  ...
  protoOf(AbstractJsonLexer).discardPeeked_n2n8pl_k$ = function () {
    this.peekedString_1 = null;
  };
  ...
  protoOf(AbstractJsonLexer).consumeString2 = function (source, startPosition, current) {
    ...
    while (!(char === _Char___init__impl__6a9atx(34))) {
      if (char === _Char___init__impl__6a9atx(92)) {
        ...
        currentPosition = this.prefetchOrEof_yw6lb3_k$(appendEscape(this, lastPosition, currentPosition));
        if (currentPosition === -1) {
          this.fail$default_dmej3o_k$('Unexpected EOF', currentPosition);
        }
        lastPosition = currentPosition;
      } else {
        currentPosition = currentPosition + 1 | 0;
  ...
  protoOf(AbstractJsonLexer).consumeNumericLiteral_rdea66_k$ = function () {
    ...
    $l$loop_4: while (!(current === charSequenceLength(this.get_source_jl0x7o_k$()))) {
      ...
      if (hasExponent) {
        ...
        exponentAccumulator = exponentAccumulator.times_2zfqpc_k$(new Long(10, 0)).plus_u6jwas_k$(toLong(digit));
        continue $l$loop_4;
      }
      // Inline function 'kotlin.Long.minus' call
      // Inline function 'kotlin.Long.times' call
      accumulator = accumulator.times_2zfqpc_k$(new Long(10, 0)).minus_llf5ei_k$(toLong(digit));
    ...
    if (hasExponent) {
      ...
      if (!(Math.floor(doubleAccumulator) === doubleAccumulator)) {
        this.fail$default_dmej3o_k$("Can't convert " + doubleAccumulator + ' to Long');
      }
  ...
  protoOf(StringJsonLexer).consumeNextToken_ev7fkz_k$ = function (expected) {
    ...
    this.set_currentPosition_b6llm3_k$(-1);
    this.unexpectedToken_v8110b_k$(expected);
  };
  protoOf(StringJsonLexer).consumeKeyString_mfa3ws_k$ = function () {
    ...
    if (closingQuote === -1) {
      this.consumeStringLenient_9oypvu_k$();
      this.fail_7e8ajq_k$(get_TC_STRING(), false);
    }
  ...
  protoOf(StringJsonLexer).peekLeadingMatchingValue_n1f74e_k$ = function (keyToMatch, isLenient) {
    var positionSnapshot = this.get_currentPosition_ic997d_k$();
    try {
      if (!(this.consumeNextToken_uf1vsa_k$() === get_TC_BEGIN_OBJ()))
        return null;
      var firstKey = this.peekString_9klnyq_k$(isLenient);
      if (!(firstKey === keyToMatch))
        return null;
      this.discardPeeked_n2n8pl_k$();
      if (!(this.consumeNextToken_uf1vsa_k$() === get_TC_COLON()))
        return null;
      return this.peekString_9klnyq_k$(isLenient);
    }finally {
